...
- [👨‍💻 Developer](#developer)
  - [`generate-api-endpoint.md`](#generate-api-endpointmd)
  - [`debug-error.md`](#debug-errormd)
  - [`refactor-file.md`](#refactor-filemd)
  - [`write-tests.md`](#write-testsmd)
  - [`database-migration.md`](#database-migrationmd)
  - [`code-review.md`](#code-reviewmd)
  - [`generate-commit-message.md`](#generate-commit-messagemd)
  - [`generate-docs.md`](#generate-docsmd)
- [🐳 DevOps Engineer](#devops-engineer)
  - [`create-dockerfile.md`](#create-dockerfilemd)
  - [`optimize-dockerfile.md`](#optimize-dockerfilemd)
  - [`create-github-actions.md`](#create-github-actionsmd)
  - [`docker-compose-stack.md`](#docker-compose-stackmd)
  - [`security-audit-config.md`](#security-audit-configmd)
  - [`deploy-script.md`](#deploy-scriptmd)
  - [`ci-debug.md`](#ci-debugmd)
- [🚨 SRE](#sre)
  - [`incident-response.md`](#incident-responsemd)
  - [`sli-slo-review.md`](#sli-slo-reviewmd)
  - [`postmortem-draft.md`](#postmortem-draftmd)
  - [`runbook-generate.md`](#runbook-generatemd)
  - [`capacity-planning.md`](#capacity-planningmd)
  - [`chaos-run.md`](#chaos-runmd)
  - [`performance-analysis.md`](#performance-analysismd)
- [☁️ Cloud Engineer](#cloud-engineer)
  - [`terraform-module.md`](#terraform-modulemd)
  - [`terraform-plan-review.md`](#terraform-plan-reviewmd)
  - [`kubernetes-manifest.md`](#kubernetes-manifestmd)
  - [`k8s-debug.md`](#k8s-debugmd)
  - [`iam-policy-review.md`](#iam-policy-reviewmd)
  - [`cloud-cost-analyze.md`](#cloud-cost-analyzemd)
  - [`vpc-network-review.md`](#vpc-network-reviewmd)
- [🏗️ Infrastructure Engineer](#infrastructure-engineer)
  - [`server-provision.md`](#server-provisionmd)
  - [`dns-debug.md`](#dns-debugmd)
  - [`nginx-tls-setup.md`](#nginx-tls-setupmd)
  - [`backup-strategy.md`](#backup-strategymd)
  - [`monitoring-stack-setup.md`](#monitoring-stack-setupmd)
  - [`log-pipeline-setup.md`](#log-pipeline-setupmd)
  - [`ssl-cert-check.md`](#ssl-cert-checkmd)
- [🧰 Cross-Role Utilities](#cross-role-utilities)
  - [`project-onboard.md`](#project-onboardmd)
  - [`config-review.md`](#config-reviewmd)
  - [`shell-script-audit.md`](#shell-script-auditmd)
  - [`readme-generator.md`](#readme-generatormd)
